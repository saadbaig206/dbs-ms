    ...
    <div className="flex flex-col h-full bg-[#0F172A] text-slate-300 select-none border-r border-slate-800">
      ...
      <div className="flex items-center justify-between p-5 border-b border-slate-800/80">
        <Link href="/dashboard" className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-blue-600 to-indigo-600 flex items-center justify-center text-white shadow-lg shadow-blue-500/20 shrink-0">
      ...
      <div className="p-3 border-t border-slate-800/80 bg-slate-950/40 space-y-2">
        {!isCollapsed && (
          <div className="p-3 rounded-2xl bg-slate-900 border border-slate-800 flex items-center justify-between">
            ...
            <button
              onClick={toggleRole}
              className="text-[11px] bg-blue-600/20 text-blue-400 hover:bg-blue-600/30 px-2 py-1 rounded-lg font-medium transition-colors"
            >
              Switch
            </button>
          </div>
